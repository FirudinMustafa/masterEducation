...
function LoginPageInner() {
  ...
  const justRegistered = sp.get("kayit") === "basarili";
  ...
  return (
    <AuthShell
      title="Giris yapin"
      subtitle="Hesabiniza giris yaparak siparislerinizi takip edin."
      footer={
    ...
    >
      {justRegistered && (
        <div className="mb-6 flex items-start gap-2 rounded-2xl border border-emerald-100 bg-emerald-50 px-4 py-3 text-sm text-emerald-800">
          ...
          <span>Kaydiniz olusturuldu. Email ve sifrenizle giris yapabilirsiniz.</span>
        </div>
      )}
      ...
      {/* Bayi girisi — kompakt secondary CTA, kart hissi yok */}
