...
export const metadata: Metadata = { title: "Siparişlerim - Bayi Paneli" };
...
export default async function DealerOrdersPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-display font-bold text-brand-black mb-6">Siparişlerim</h1>

      {orders.length === 0 ? (
        <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
          <p className="text-gray-500">Henuz siparişsiniz bulunmamaktadir.</p>
        </div>
      ) : (
          ...
          {orders.map((order) => (
            <div key={order.id} className="bg-white rounded-xl border border-gray-200 overflow-hidden">
              ...
              <div className="p-4">
                ...
                {/* Admin notlarini gösterilen son 3 OrderEvent'tan oku */}
